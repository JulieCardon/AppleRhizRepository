...
error_forward_reads2 <- 
  learnErrors(filtered_forward_reads2, multithread = TRUE)
# Plot Forward  
forward_error_plot2 <- 
  plotErrors(error_forward_reads2, nominalQ = TRUE) + 
  labs(title = "Forward Read Error Model 2022")

# Reverse reads 
error_reverse_reads2 <- 
  learnErrors(filtered_reverse_reads2, multithread = TRUE)
# Plot reverse
reverse_error_plot2 <- 
  plotErrors(error_reverse_reads2, nominalQ = TRUE) + 
...
# Make a track read counts that merges both 2022 and 2023 data

```{r combine-track-reads}
str(track_counts_df2)
colnames(track_counts_df2)
colnames(track_counts_df3)
